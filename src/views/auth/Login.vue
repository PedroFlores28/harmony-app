      ...
      <div class="login-inputs-container">
        <div class="input-group">
          ...
          <div class="input-wrapper" style="position: relative; display: inline-block;">
            ...
            >
              <path d="M19.25 7.58337C19.25 10.4779 16.8945 12.8334 14 12.8334C11.1055 12.8334 8.75 10.4779 8.75 7.58337C8.75 4.68887 11.1055 2.33337 14 2.33337C16.8945 2.33337 19.25 4.68887 19.25 7.58337ZM4.66667 24.5H3.5V23.3334C3.5 18.8312 7.1645 15.1667 11.6667 15.1667H16.3333C20.8367 15.1667 24.5 18.8312 24.5 23.3334V24.5H4.66667Z" fill="#BE9FB0"/>
            </svg>
          </div>
        </div>
