    ...
    <section v-else>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper" style="position: relative; display: inline-block;">
            <input
              id="dni"
              class="input"
              style="border: solid 2px #5C0F39; padding-right: 40px; border-radius: 0;"
              placeholder="Usuario"
            ...
            >
              <path d="M19.25 7.58337C19.25 10.4779 16.8945 12.8334 14 12.8334C11.1055 12.8334 8.75 10.4779 8.75 7.58337C8.75 4.68887 11.1055 2.33337 14 2.33337C16.8945 2.33337 19.25 4.68887 19.25 7.58337ZM4.66667 24.5H3.5V23.3334C3.5 18.8312 7.1645 15.1667 11.6667 15.1667H16.3333C20.8367 15.1667 24.5 18.8312 24.5 23.3334V24.5H4.66667Z" fill="#8B6B80"/>
            </svg>
          </div>
        </div>
     ...
     <!-- <br /><br /> -->
      ...
      <small style="color: #89888D; margin-top: 8px; display: block;"
        ...
        <router-link to="/remember" style="color: #5C0F39"
      ...
      <header>
        <div class="social">
          <div class="social-icon facebook">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="40" height="40" rx="13" fill="#8B6B80" fill-opacity="0.6"/>
        ...
        <div class="login-link">
          <small style="color: #89888D; margin-top: -14px; display: block;">
            ...
            <router-link
              to="/register"
              style="color: #5C0F39; text-decoration: none"
